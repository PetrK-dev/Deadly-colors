...
export const Levels = [
	[3, 10, 0, 0.3, 1.0, 1, 0], //1
	[3, 25, 0, 0.6, 1.3, 1, 0],
	[3, 30, 0, 0.6, 1.8, 1, 0],
	[3, 30, 0, 0.7, 2.0, 1, 0],
	[3, 35, 0, 0.85, 2.4, 1, 0], //5
	[3, 25, 1, 0.6, 1.6, 1, 0],
	[3, 30, 1, 0.75, 1.9, 1, 0],
	[3, 25, 0, 0.3, 1.0, 0, 1],
	[3, 25, 1, 0.3, 1.2, 0, 1],
	[3, 35, 0, 0.6, 1.3, 0.8, 0.2], //10
	[3, 35, 1, 0.6, 1.3, 0.7, 0.3],
	[3, 40, 1, 0.7, 1.5, 0.8, 0.2],
	[3, 40, 1, 0.8, 1.8, 0.85, 0.15],
	[4, 10, 0, 0.3, 1.0, 1, 0],
	[4, 25, 0, 0.6, 1.3, 1, 0], //15
	[4, 30, 0, 0.6, 1.8, 1, 0],
	[4, 35, 0, 0.7, 2.2, 1, 0],
	[4, 25, 1, 0.6, 1.6, 1, 0],
	[4, 30, 1, 0.7, 2.0, 1, 0],
	[4, 25, 0, 0.3, 1.0, 0, 1], //20
	[4, 25, 1, 0.35, 1.5, 0, 1],
	[4, 35, 0, 0.6, 1.2, 0.8, 0.2],
	[4, 35, 1, 0.6, 1.3, 0.7, 0.3],
	[4, 40, 1, 0.7, 1.8, 0.85, 0.15],
	[4, 40, 1, 0.75, 2.0, 0.9, 0.1], //25
	[4, 40, 1, 0.85, 2.3, 0.9, 0.1],
	[4, 50, 1, 0.9, 2.4, 0.93, 0.07],
	[0, 0, 0, 0.0, 0.0, 0, 0],
];
